...
HELP_TEXT_PUBLIC = (
    ...
    "\n"
    "Pictures: post a photo, sticker, GIF or video and I see what's in it, "
    "and I keep it. Reply to one to ask my read; say 'dale send that pic of "
    "X' or /pic X to get one back; /pics lists recent. 👁 toggle in /config.\n"
    "\n"
...
HELP_TEXT_ADMIN = (
    ...
    "\n"
    "Memory repair:\n"
    "/unlearn <the false belief> - scrub something the chat gaslit me into "
    "(facts, summary, my own messages) and leave a correction\n"
    "\n"
    "Dale GIFs:\n"
    "/dalegif <tags> - reply this to a GIF to save it to the library "
    "(Telegram's GIF picker is Tenor — search 'dale gribble', send, reply)\n"
    "/dalegif list [tag], /dalegif test <tag>, /dalegif remove <id>\n"
