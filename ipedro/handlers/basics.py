...
HELP_TEXT_PUBLIC = (
    ...
    "\n"
    "Disgust test:\n"
    "/disgusttest (/icktest) - a 16-question disgust personality test with a "
    "picture per question, tap 1-6; scored profile with meters, a chat "
    "percentile, a generated result card and a Retake button. Based on the "
    "Food Disgust Scale (Hartmann & Siegrist 2018) & Disgust Scale-Revised "
    "(Olatunji 2007). For fun, not a diagnosis.\n"
    "/disgustboard - who's the most easily grossed out here\n"
    "\n"
    "Quotes & lore:\n"
